...
move_whaticket_files() {
  ...
  sudo rm -r /home/deploy/whaticket/frontend/torresticket
  sudo rm -r /home/deploy/whaticket/frontend/package.json
  sudo rm -r /home/deploy/whaticket/backend/torresticket
  sudo rm -r /home/deploy/whaticket/backend/package.json
  sudo rm -rf /home/deploy/whaticket/frontend/node_modules
  sudo rm -rf /home/deploy/whaticket/backend/node_modules

  sudo mv /root/whaticket/frontend/torresticket /home/deploy/whaticket/frontend
  sudo mv /root/whaticket/frontend/package.json /home/deploy/whaticket/frontend
  sudo mv /root/whaticket/backend/torresticket /home/deploy/whaticket/backend
  sudo mv /root/whaticket/backend/package.json /home/deploy/whaticket/backend
